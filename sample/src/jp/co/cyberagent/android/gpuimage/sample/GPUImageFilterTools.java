...
public class GPUImageFilterTools {  
    public static void showDialog(final Context context,
        ...
        filters.addFilter("Water Ripples", FilterType.WATER_RIPPLE);
    ...
    private static GPUImageFilter createFilterForType(final Context context, final FilterType type) {
        ...
        case WATER_RIPPLE:
        		//return new Wat
        		return new WaterRippleEffect(1920, 1200);
            case CONTRAST:
    ...
    private enum FilterType {
        WATER_RIPPLE, CONTRAST, GRAYSCALE, SHARPEN, SEPIA, SOBEL_EDGE_DETECTION, THREE_X_THREE_CONVOLUTION, FILTER_GROUP, EMBOSS, POSTERIZE, GAMMA, BRIGHTNESS, INVERT, HUE, PIXELATION,
    ...
    public static class FilterAdjuster {
        ...
        public FilterAdjuster(final GPUImageFilter filter) {
        	if (filter instanceof WaterRippleEffect) {
                adjuster = new WaterRippleAdjuster().filter(filter);
        ...
        private class WaterRippleAdjuster extends Adjuster<WaterRippleEffect> {
            @Override
            public void adjust(final int percentage) {
